...
// 화살표 함수 정의 코드
const greetArrow = (name2) => {
  console.log(`안녕하세요 ${name2}님!`)
}
// 함수 호출 코드
greet("김철수");
greetArrow("이영희");
...
// 함수 선언식 정의 코드
function printFromOne(N3) {
  for (i = 1; i <= N3; i++) {
    console.log(i)
  }
}
// 화살표 함수 정의 코드
const printFromOneArrow = (n) => {
  for (i = 1; i <= n; i++) {
    console.log(i)
  }
}
...
function max(num1, num2) {
  let result = num1 < num2 ? num2 : num1 || num2
  return result
}
// 화살표 함수 정의 코드
const maxArrow = (num1, num2) => {
  return num1 < num2 ? num2 : num1 || num2
}
// 함수 호출 코드
